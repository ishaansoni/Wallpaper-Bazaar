<?php 
$title = "Most Downloaded HD Wallpapers";
?>
...
$page_q="select count(*) \"total\"  from wallpaper order by w_download desc";
...
$q="select * from wallpaper order by w_download desc LIMIT $k,$item";
